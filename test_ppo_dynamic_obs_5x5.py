#!/usr/bin/env python3
"""
Quick evaluator for PPO Dynamic Obstacles 5x5 checkpoint.
...
class MinigridFeaturesExtractor(BaseFeaturesExtractor):
    """Feature extractor matching the 2-layer CNN architecture used during 5x5 training."""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Test PPO Dynamic Obstacles 5x5 model")
    parser.add_argument("--model_path", type=str, default="ppo_dynamic_obs_5x5.zip")
    parser.add_argument("--env_name", type=str, default="MiniGrid-Dynamic-Obstacles-5x5-v0")
