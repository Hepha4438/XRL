...
class MinigridFeaturesExtractor(BaseFeaturesExtractor):
    def __init__(self, observation_space: gym.Space, features_dim: int = 128):
        ...
        # Standard 2-layer CNN architecture for 5x5 grids
...
def make_env(render_mode=None, seed=0):
    def _init():
        env = gym.make("MiniGrid-Dynamic-Obstacles-5x5-v0", render_mode=render_mode)
...
def main():
    ...
    model = PPO(
        ...
        max_grad_norm=0.5,
        verbose=1,
        tensorboard_log="./tb_dynamic_obs_5x5/",
        seed=seed,
        device=device,
    )
    ...
    eval_callback = EvalCallback(
        eval_env,
        best_model_save_path="./best_dynamic_obs_5x5/",
        log_path="./eval_logs_dynamic_obs_5x5/",
        eval_freq=5000,
        n_eval_episodes=20,
        deterministic=True,
        render=False,
    ...
    model.learn(total_timesteps=750_000, callback=eval_callback)
    model.save("ppo_dynamic_obs_5x5")
