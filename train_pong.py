...
if __name__ == "__main__":
    ...
    ap.add_argument("--out", default="runs/pong_s0")
    a = ap.parse_args()
    ...
    model = PPO(
        ...
        learning_rate=2.5e-4 if a.const_lr else lin(2.5e-4),
        clip_range=0.1 if a.const_lr else lin(0.1),
    ...
    model.learn(
        ...
        callback=EvalCallback(eval_env, best_model_save_path=f"{a.out}/best",
                              log_path=f"{a.out}/eval",
                              eval_freq=max(50_000 // a.n_envs, 1),
